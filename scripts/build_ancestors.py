...
def main(argv: list[str] | None = None) -> None:
    ...
    parser.add_argument("--tiny", action="store_true", help="Operate on etl-tiny/ instead of etl/.")
    ...
    etl_dir = args.etl_dir or (Path.home() / "genterp" / ("etl-tiny" if args.tiny else "etl"))
